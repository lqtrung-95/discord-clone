...
__decorate([
    (0, common_1.Get)('/:guildId'),
    (0, common_1.UseGuards)(member_guard_1.MemberGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Get Guild Channels' }),
    (0, swagger_1.ApiBody)({ description: 'guildId', type: String }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOkResponse)({ type: [ChannelResponse_1.ChannelResponse] }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get Private Guild Members' }),
    (0, swagger_1.ApiBody)({ description: 'channelId', type: String }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOkResponse)({ description: 'Member Ids', type: [String] }),
...
__decorate([
    (0, common_1.Post)('/:guildId'),
    (0, common_1.UseGuards)(member_guard_1.MemberGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Create Guild Channels' }),
    (0, swagger_1.ApiBody)({ type: ChannelInput_1.ChannelInput }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiCreatedResponse)({ type: Boolean }),
    __param(0, (0, user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Param)('guildId')),
    __param(2, (0, common_1.Body)(new yupValidationPipe_1.YupValidationPipe(channel_schema_1.ChannelSchema), new common_1.ValidationPipe({ transform: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, ChannelInput_1.ChannelInput]),
    __metadata("design:returntype", Promise)
], ChannelController.prototype, "createChannel", null);
__decorate([
    (0, common_1.Get)('/me/dm'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Get User\'s DMs' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOkResponse)({ type: [DMChannelResponse_1.DMChannelResponse] }),
    __param(0, (0, user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Post)(':memberId/dm'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Start or get DMs with the given user' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOkResponse)({ type: DMChannelResponse_1.DMChannelResponse }),
    __param(0, (0, user_decorator_1.GetUser)()),
...
__decorate([
    (0, common_1.Put)("/:guildId/:channelId"),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Edit Channel' }),
...
__decorate([
    (0, common_1.Delete)('/:channelId/dm'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Close the DM' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Close Success', type: Boolean }),
    (0, swagger_1.ApiUnauthorizedResponse)(),
    __param(0, (0, user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Param)('channelId')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Delete)("/:guildId/:channelId"),
    (0, common_1.UseGuards)(member_guard_1.MemberGuard),
    (0, swagger_1.ApiCookieAuth)(),
...
ChannelController = __decorate([
    (0, swagger_1.ApiTags)('Channel Operation'),
