...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get Channel Messages' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid credentials' }),
    (0, swagger_1.ApiCookieAuth)(),
    (0, swagger_1.ApiOkResponse)({ type: [MessageResponse_1.MessageResponse] }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Message Success', type: Boolean }),
    (0, swagger_1.ApiUnauthorizedResponse)(),
    (0, swagger_1.ApiBody)({ type: MessageInput_1.MessageInput }),
    (0, swagger_1.ApiConsumes)('multipart/form-data'),
    __param(0, (0, user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Param)('channelId')),
    __param(2, (0, common_1.Body)(new yupValidationPipe_1.YupValidationPipe(message_schema_1.MessageSchema))),
...
MessageController = __decorate([
    (0, swagger_1.ApiTags)('Message Operation'),
