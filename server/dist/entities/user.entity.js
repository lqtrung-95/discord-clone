...
let User = User_1 = class User extends abstract_entity_1.AbstractEntity {
    toJSON() {
        return (0, class_transformer_1.classToPlain)(this, { groups: ['user'] });
    }
...
__decorate([
    ...
    (0, class_transformer_1.Expose)({ groups: ['user'] }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => channel_entity_1.Channel),
    (0, typeorm_1.JoinColumn)({ name: 'channel_member' }),
    __metadata("design:type", Array)
], User.prototype, "channels", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => pcmember_entity_1.PCMember, (pcmember) => pcmember.user),
    __metadata("design:type", Array)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => ban_entity_1.BanEntity, (bans) => bans.user),
    __metadata("design:type", Array)
